    ...
    <el-form label-position="top">
      <template>
        <el-form-item
          ...
          >
            <el-input v-model="tableName" size="mini" @focus="getTableListData">
            </el-input>
        </el-form-item>
        <!-- <el-form-item
            label="表格编码"
        ...
        <div v-if="tableName != ''">
          ...
          <div v-if="data.options.isPagination">
            <el-form-item label-width="100px" label="每页条目个数">
              <el-input v-model="data.options.pagination.pageSize" size="mini">
              </el-input>
            </el-form-item>
        ...
        <el-dialog :visible.sync="dialogTableVisible">
          <div style="display:flex;marginBottom:20px;">
            <el-input style="width:200px" placeholder="请输入内容" v-model="tablePageCf.searchValue" clearable>
            </el-input>
            <el-button
              type="primary"
  ...
  methods: {
    ...
    openCode(type){
      ...
      if(type == "handleCurrentChange"){
       this.tableCodeCf.tableCodeFn = "function main(page){debugger; console.log(page);}"
      }else if(type == "handleSizeChange"){
        this.tableCodeCf.tableCodeFn = "function mian(page){debugger; console.log(page);}"
